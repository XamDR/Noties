...
import net.azurewebsites.eznotes.databinding.NoteItemBinding
import net.azurewebsites.eznotes.ui.editor.TextEditorFragment
import net.azurewebsites.eznotes.ui.helpers.addItemTouchHelper
...
class NoteAdapter : ListAdapter<Note, NoteAdapter.NoteViewHolder>(NoteAdapterCallback()) {
	...
	private fun editNote(holder: RecyclerView.ViewHolder, position: Int) {
		val note = getItem(position)
		val args = bundleOf(TextEditorFragment.NOTE to note)
