...
import net.azurewebsites.eznotes.databinding.ImageItemBinding
import net.azurewebsites.eznotes.databinding.SingleImageItemBinding
import net.azurewebsites.eznotes.ui.helpers.printDebug
import net.azurewebsites.eznotes.ui.helpers.setOnClickListener
import net.azurewebsites.eznotes.util.isSingleton

class MediaItemAdapter : ListAdapter<MediaItemEntity, BaseMediaItemViewHolder>(MediaItemAdapterCallback()) {
	...
	private fun showAltTextDialog(position: Int, view: View) {
		val parentView = LayoutInflater.from(view.context).inflate(R.layout.alt_text_image_dialog, null)
	...
	private class MediaItemAdapterCallback : DiffUtil.ItemCallback<MediaItemEntity>() {
